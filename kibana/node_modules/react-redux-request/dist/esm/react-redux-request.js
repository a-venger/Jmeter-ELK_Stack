...
var maybeFetchData = function () {
  var _ref2 = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(_ref) {
    var args = _ref.args,
        didArgsChange = _ref.didArgsChange,
        dispatch = _ref.dispatch,
        fn = _ref.fn,
        id = _ref.id,
        preventFetch = _ref.preventFetch;
    var ctx = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    var shouldFetchData, fetchId, data;
  ...
  return function maybeFetchData(_x2) {
...
var ReactReduxRequestView = function (_React$Component) {
  inherits(ReactReduxRequestView, _React$Component);

  function ReactReduxRequestView() {
    classCallCheck(this, ReactReduxRequestView);
    return possibleConstructorReturn(this, (ReactReduxRequestView.__proto__ || Object.getPrototypeOf(ReactReduxRequestView)).apply(this, arguments));
  }

  createClass(ReactReduxRequestView, [{
...
var mapStateToProps = function mapStateToProps(state, ownProps) {
  ...
  try {
    selectorResult = selector(state, { id: id });
  } catch (e) {
...
var Request = connect(mapStateToProps, mapDispatchToProps)(ReactReduxRequestView);
...
export { getRequestState, Request, reducer };
