Arguments: 
  /usr/local/bin/node /usr/local/Cellar/yarn/1.2.1/libexec/bin/yarn.js test
...
npm manifest: 
  {
    ...
    "scripts": {
      ...
      "test": "jest --verbose  --setupTestFrameworkScriptFile ./jest.config.js"
    },
  }
...
Lockfile: 
  ...
  lodash@^4.14.0, lodash@^4.15.0, lodash@^4.17.2, lodash@^4.17.4, lodash@^4.2.0, lodash@^4.3.0:
    version "4.17.4"
...
Trace: 
  SyntaxError: /Users/justinschrader/Desktop/KOAN/opensource/react-router-breadcrumbs-hoc/package.json: Unexpected token } in JSON at position 1443
