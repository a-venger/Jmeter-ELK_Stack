...
exports.EuiHorizontalRectSeries = undefined;
...
var EuiHorizontalRectSeries = exports.EuiHorizontalRectSeries = function (_HorizontalRectSeries) {
  ...
  function EuiHorizontalRectSeries() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = EuiHorizontalRectSeries.__proto__ || Object.getPrototypeOf(EuiHorizontalRectSeries)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
  ...
  _createClass(EuiHorizontalRectSeries, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(_reactVis.HorizontalRectSeries, _extends({
        key: name,
        className: classes,
