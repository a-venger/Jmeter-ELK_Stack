...
var EuiYAxis = exports.EuiYAxis = function (_PureComponent) {
  _inherits(EuiYAxis, _PureComponent);

  function EuiYAxis() {
    _classCallCheck(this, EuiYAxis);

    return _possibleConstructorReturn(this, (EuiYAxis.__proto__ || Object.getPrototypeOf(EuiYAxis)).apply(this, arguments));
  }
  ...
  _createClass(EuiYAxis, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(_reactVis.YAxis, _extends({
        title: title,
...
EuiYAxis.propTypes = {
  ...
  orientation: _propTypes2.default.oneOf([ORIENTATION.LEFT, ORIENTATION.RIGHT]),
