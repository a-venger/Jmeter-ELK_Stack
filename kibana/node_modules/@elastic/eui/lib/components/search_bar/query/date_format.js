...
exports.dateFormat = exports.dateGranularity = exports.printIso8601 = exports.Granularity = undefined;
...
var parseDefault = function parseDefault(value) {
  var parsed = utc(value, [_moment2.default.ISO_8601, _moment2.default.RFC_2822, 'DD MMM YY HH:mm', 'DD MMM YY HH:mm:ss', 'DD MMM YYYY HH:mm', 'DD MMM YYYY HH:mm:ss', 'DD MMMM YYYY HH:mm', 'DD MMMM YYYY HH:mm:ss'], true);
  if (!parsed.isValid()) {
    var time = Date.parse(value);
    var offset = (0, _moment2.default)(time).utcOffset();
    parsed = utc(time);
...
var printIso8601 = exports.printIso8601 = function printIso8601(value) {
  return utc(value).format(_moment2.default.defaultFormatUtc);
};
...
var dateFormat = exports.dateFormat = Object.freeze({
  ...
  print: function print(date) {
    ...
    date = _moment2.default.isMoment(date) ? date : utc(date);
    var now = utc();
