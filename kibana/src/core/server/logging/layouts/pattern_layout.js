...
const patternLayoutSchema = schema_1.schema.object({
    highlight: schema_1.schema.maybe(schema_1.schema.boolean()),
    kind: schema_1.schema.literal('pattern'),
    pattern: schema_1.schema.maybe(schema_1.schema.string()),
});
/**
