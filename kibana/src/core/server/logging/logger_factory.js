...
class MutableLoggerFactory {
    ...
    updateConfig(config) {
        ...
        for (const [appenderKey, appenderConfig] of config.appenders.entries()) {
            this.appenders.set(appenderKey, appenders_1.Appenders.create(appenderConfig, this.env));
        }
...
exports.MutableLoggerFactory = MutableLoggerFactory;
