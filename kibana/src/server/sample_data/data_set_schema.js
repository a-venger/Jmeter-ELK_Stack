...
exports.dataSetSchema = undefined;
...
const dataSetSchema = exports.dataSetSchema = {
  ...
  overviewDashboard: _joi2.default.string().required(), // saved object id of main dashboard for sample data set
  defaultIndex: _joi2.default.string().required(), // saved object id of default index-pattern for sample data set
  dataPath: _joi2.default.string().required(), // path to newline delimented JSON file containing data relative to KIBANA_HOME
  fields: _joi2.default.object().required(), // Object defining Elasticsearch field mappings (contents of index.mappings.type.properties)
