...
exports.default = async () => _joi2.default.object({
  ...
  map: _joi2.default.object({
    manifestServiceUrl: _joi2.default.string().default(' https://catalogue.maps.elastic.co/v2/manifest'),
    emsLandingPageUrl: _joi2.default.string().default('https://maps.elastic.co/v2'),
  ...
  __newPlatform: _joi2.default.any()
