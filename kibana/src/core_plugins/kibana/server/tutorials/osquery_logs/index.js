...
function osqueryLogsSpecProvider() {
  ...
  return {
    ...
    longDescription: 'The `osquery` Filebeat module collects the JSON result logs collected by `osqueryd`.' + ' [Learn more]({config.docs.beats.filebeat}/filebeat-module-osquery.html).',
