...
function kubernetesMetricsSpecProvider() {
  ...
  return {
    ...
    longDescription: 'The `kubernetes` Metricbeat module fetches metrics from the Kubernetes APIs.' + ' [Learn more]({config.docs.beats.metricbeat}/metricbeat-module-kubernetes.html).',
