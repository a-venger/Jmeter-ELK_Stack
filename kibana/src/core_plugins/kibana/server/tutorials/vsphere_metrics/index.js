...
function vSphereMetricsSpecProvider() {
  ...
  return {
    ...
    longDescription: 'The `vsphere` Metricbeat module fetches internal metrics from a vSphere cluster.' + ' [Learn more]({config.docs.beats.metricbeat}/metricbeat-module-vsphere.html).',
