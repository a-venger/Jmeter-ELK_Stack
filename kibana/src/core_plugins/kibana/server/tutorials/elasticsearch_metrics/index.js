...
function elasticsearchMetricsSpecProvider() {
  ...
  return {
    ...
    longDescription: 'The `elasticsearch` Metricbeat module fetches internal metrics from Elasticsearch.' + ' [Learn more]({config.docs.beats.metricbeat}/metricbeat-module-elasticsearch.html).',
