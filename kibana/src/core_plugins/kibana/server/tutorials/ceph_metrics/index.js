...
function cephMetricsSpecProvider() {
  ...
  return {
    ...
    longDescription: 'The `ceph` Metricbeat module fetches internal metrics from Ceph.' + ' [Learn more]({config.docs.beats.metricbeat}/metricbeat-module-ceph.html).',
    artifacts: {
      application: {
        label: 'Discover',
