...
function dropwizardMetricsSpecProvider() {
  ...
  return {
    ...
    longDescription: 'The `dropwizard` Metricbeat module fetches internal metrics from Dropwizard Java Application.' + ' [Learn more]({config.docs.beats.metricbeat}/metricbeat-module-dropwizard.html).',
    artifacts: {
      application: {
        label: 'Discover',
