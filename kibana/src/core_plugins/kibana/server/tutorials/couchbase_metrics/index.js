...
function couchbaseMetricsSpecProvider() {
  ...
  return {
    ...
    longDescription: 'The `couchbase` Metricbeat module fetches internal metrics from Couchbase.' + ' [Learn more]({config.docs.beats.metricbeat}/metricbeat-module-couchbase.html).',
    artifacts: {
      application: {
        label: 'Discover',
