...
function aerospikeMetricsSpecProvider() {
  ...
  return {
    ...
    longDescription: 'The `aerospike` Metricbeat module fetches internal metrics from Aerospike.' + ' [Learn more]({config.docs.beats.metricbeat}/metricbeat-module-aerospike.html).',
    artifacts: {
      application: {
        label: 'Discover',
