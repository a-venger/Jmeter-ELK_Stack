...
function logstashMetricsSpecProvider() {
  ...
  return {
    ...
    longDescription: 'The `' + moduleName + '` Metricbeat module fetches internal metrics from a Logstash server.' + ' [Learn more]({config.docs.beats.metricbeat}/metricbeat-module-' + moduleName + '.html).',
