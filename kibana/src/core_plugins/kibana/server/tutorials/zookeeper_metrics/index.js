...
function zookeeperMetricsSpecProvider() {
  ...
  return {
    ...
    longDescription: 'The `' + moduleName + '` Metricbeat module fetches internal metrics from a Zookeeper server.' + ' [Learn more]({config.docs.beats.metricbeat}/metricbeat-module-' + moduleName + '.html).',
    artifacts: {
      application: {
        label: 'Discover',
