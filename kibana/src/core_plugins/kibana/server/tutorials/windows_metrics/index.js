...
function windowsMetricsSpecProvider() {
  ...
  return {
    ...
    longDescription: 'The `windows` Metricbeat module fetches internal metrics from Windows.' + ' [Learn more]({config.docs.beats.metricbeat}/metricbeat-module-windows.html).',
    artifacts: {
      application: {
        label: 'Discover',
