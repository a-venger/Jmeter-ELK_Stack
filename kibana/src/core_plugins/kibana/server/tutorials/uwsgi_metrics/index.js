...
function uwsgiMetricsSpecProvider() {
  ...
  return {
    ...
    longDescription: 'The `uwsgi` Metricbeat module fetches internal metrics from the uWSGI server.' + ' [Learn more]({config.docs.beats.metricbeat}/metricbeat-module-uwsgi.html).',
