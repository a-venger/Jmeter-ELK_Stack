...
function kafkaMetricsSpecProvider() {
  ...
  return {
    ...
    longDescription: 'The `kafka` Metricbeat module fetches internal metrics from Kafka.' + ' [Learn more]({config.docs.beats.metricbeat}/metricbeat-module-kafka.html).',
    artifacts: {
      application: {
        label: 'Discover',
