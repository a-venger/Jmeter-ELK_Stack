...
function muninMetricsSpecProvider() {
  ...
  return {
    ...
    longDescription: 'The `munin` Metricbeat module fetches internal metrics from Munin.' + ' [Learn more]({config.docs.beats.metricbeat}/metricbeat-module-munin.html).',
    artifacts: {
      application: {
        label: 'Discover',
