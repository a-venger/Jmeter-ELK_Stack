...
const TRYCLOUD_OPTION1 = exports.TRYCLOUD_OPTION1 = {
...
const TRYCLOUD_OPTION2 = exports.TRYCLOUD_OPTION2 = {
  title: 'Option 2: Connect local Kibana to a Cloud instance',
  textPre: 'If you are running this Kibana instance against a hosted Elasticsearch instance,' + ' proceed with manual setup.\n\n' + 'Save the **Elasticsearch** endpoint as `<es_url>` and the cluster **Password** as `<password>` for your records'
};