...
exports.default = new _chainable2.default('color', {
  args: [{
    ...
    name: 'color',
    types: ['string'],
    help: 'Color of series, as hex, e.g., #c6c6c6 is a lovely light grey. If you specify multiple colors, and have ' + 'multiple series, you will get a gradient, e.g., "#00B1CC:#00FF94:#FF3A39:#CC1A6F"'
  }],
