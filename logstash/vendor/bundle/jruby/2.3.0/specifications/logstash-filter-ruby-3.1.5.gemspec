# -*- encoding: utf-8 -*-
# stub: logstash-filter-ruby 3.1.5 ruby lib

Gem::Specification.new do |s|
  s.name = "logstash-filter-ruby".freeze
  s.version = "3.1.5"
  ...
  s.summary = "Executes arbitrary Ruby code".freeze
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<logstash-filter-date>.freeze, [">= 0"])
