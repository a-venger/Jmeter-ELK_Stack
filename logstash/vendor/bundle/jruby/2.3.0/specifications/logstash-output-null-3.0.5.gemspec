# -*- encoding: utf-8 -*-
# stub: logstash-output-null 3.0.5 ruby lib

Gem::Specification.new do |s|
  s.name = "logstash-output-null".freeze
  s.version = "3.0.5"
  ...
  s.summary = "A null output. This is useful for testing logstash inputs and filters for performance.".freeze
