# -*- encoding: utf-8 -*-
# stub: logstash-input-twitter 3.0.8 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<twitter>.freeze, ["= 5.15.0"])
      s.add_runtime_dependency(%q<http-form_data>.freeze, ["<= 1.0.1"])
      s.add_runtime_dependency(%q<public_suffix>.freeze, ["<= 1.4.6"])
      s.add_runtime_dependency(%q<stud>.freeze, ["< 0.1", ">= 0.0.22"])
