# -*- encoding: utf-8 -*-
# stub: logstash-input-stdin 3.2.6 ruby lib

Gem::Specification.new do |s|
  s.name = "logstash-input-stdin".freeze
  s.version = "3.2.6"
  ...
  s.summary = "Reads events from standard input".freeze
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<jruby-stdin-channel>.freeze, [">= 0"])
      ...
      s.add_dependency(%q<jruby-stdin-channel>.freeze, [">= 0"])
