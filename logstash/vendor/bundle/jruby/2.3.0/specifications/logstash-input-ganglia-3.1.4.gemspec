# -*- encoding: utf-8 -*-
# stub: logstash-input-ganglia 3.1.4 ruby lib

Gem::Specification.new do |s|
  s.name = "logstash-input-ganglia".freeze
  s.version = "3.1.4"
  ...
  s.summary = "Reads Ganglia packets over UDP".freeze
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<gmetric>.freeze, [">= 0"])
    else
      ...
      s.add_dependency(%q<gmetric>.freeze, [">= 0"])
    end
  else
    s.add_dependency(%q<logstash-core-plugin-api>.freeze, ["<= 2.99", ">= 1.60"])
    s.add_dependency(%q<stud>.freeze, ["~> 0.0.22"])
