# -*- encoding: utf-8 -*-
# stub: logstash-input-snmptrap 3.0.6 ruby lib

Gem::Specification.new do |s|
  s.name = "logstash-input-snmptrap".freeze
  s.version = "3.0.6"
  ...
  s.summary = "Creates events based on SNMP trap messages".freeze
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<snmp>.freeze, [">= 0"])
      ...
      s.add_dependency(%q<snmp>.freeze, [">= 0"])
